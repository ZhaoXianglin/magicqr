...
public class AudioRecorder {
    ...
    public void start() throws IOException {
        ...
        mMediaRecorder.setOutputFormat(MediaRecorder.OutputFormat.MPEG_4);//RAW_AMR
        mMediaRecorder.setAudioEncoder(MediaRecorder.AudioEncoder.AAC);//AMR_NB
