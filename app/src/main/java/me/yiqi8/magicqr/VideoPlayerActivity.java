...
import me.yiqi8.qrcode.vedio.MyVideoView;
import me.yiqi8.qrcode.vedio.SoundView;
import me.yiqi8.qrcode.vedio.MyVideoView.MySizeChangeLinstener;
import me.yiqi8.qrcode.vedio.SoundView.OnVolumeChangedListener;
...
public class VideoPlayerActivity extends Activity {
	...
	//privte Uri videoListUri = MediaStore.Video.Media.EXTERNAL_CONTENT_URI;
    ...
    public void onCreate(Bundle savedInstanceState) {
		...
		vv.setVideoPath(sb.toString());
        Log.i("路径",sb.toString());
        isOnline = true;
